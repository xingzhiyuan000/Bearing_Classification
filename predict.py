...
if __name__ == '__main__':
    ...
    model_path=".\models/wang_2023-05-29_19-41-08_100.pth" #预测模型路径
    #定义训练的设备
    ...
    root = "./dataset/single/time/B"  # 数据集所在根目录
    # root = "./dataset/single/fre/C"  # 数据集所在根目录
    # root = "./dataset/single/wavelet/C"  # 数据集所在根目录
